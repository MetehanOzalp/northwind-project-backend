...
public interface ProductDao extends JpaRepository<Product, Integer> {
	...
	List<Product> getByCategoryIn(int... categories);
	...
	@Query("Select new CampProject.northwind.entities.dtos.ProductWithCategoryDto(p.id, p.productName, c.categoryName) From Category c Inner Join c.products p")
